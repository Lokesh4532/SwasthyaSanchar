...
export const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    footer: {
      ...
      teamAITians: 'Team HACKOBEES',
      hackathonTitle: 'Project HACK AIT D',
      hackathonSubtitle: 'The Awakening',
      hackathonDescription: 'This is our team project for HACK AITD 2026 hackathon.',

      projectTitle: 'Medical Records Blockchain System',
      domain: 'Domain: Healthcare',
      teamLeader: 'Team Leader: Lokesh Kumar Chaturvedi',
